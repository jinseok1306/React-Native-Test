...
import { NativeBaseProvider, Pressable, Badge, Spacer, Text, HStack, Box, Flex, Center} from 'native-base';

const NBPressableComponent = () => {    
        ...
        <NativeBaseProvider>
            <SafeAreaView>
                ...
                <ScrollView>
                    ...
                    <Text>{"\n"}</Text> 
                    <Text style={styles.subHeader}>Accessing event</Text>
                    <Divider />            
                    <Text>{"\n"}</Text>             
                    <Center>
                        <Pressable>
...
export default NBPressableComponent;  