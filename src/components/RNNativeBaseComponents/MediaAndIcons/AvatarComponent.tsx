...
import { NativeBaseProvider, Text, Button, Center, HStack, Avatar, VStack } from 'native-base';
import Icon from 'react-native-vector-icons/Ionicons';

const NBAvatarComponent = () => {        
                ...
                <ScrollView>
                    ...
                    <Center>
                        <VStack space={2} alignItems={{
                            ...
                            <Avatar bg="cyan.500" alignSelf="center" size="sm" source={{
                                uri: "https://images.unsplash.com/photo-1603415526960-f7e0328c63b1?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80"
                            }}>
                                HS
                            </Avatar>
                    ...
                    <Text>{"\n"}</Text> 
                    <Text style={styles.subHeader}>Fallbacks</Text>
                    <Divider />            
                    <Text>{"\n"}</Text>     
                    <Center>
                    ...
                    <Text>{"\n"}</Text> 
                    <Text style={styles.subHeader}>Avatar Badge</Text>
                    <Divider />            
                    <Text>{"\n"}</Text>    
                    <Center>
                    ...
                    <Text>{"\n"}</Text> 
                    <Text style={styles.subHeader}>Avatar Group</Text>
                    <Divider />            
                    <Text>{"\n"}</Text>   
                    <Center>
...
export default NBAvatarComponent;  