...
const AuthStack = createStackNavigator(
    {
        ...
        NBHeadingComponent: {screen: RNNativeBaseComponent.NBHeadingComponent,
            navigationOptions: ({ navigation }) => ({
                title: 'Heading',
                headerStyle: {
                    backgroundColor: 'rgb(29,36,102)',                        
        ...
        NBAlertDialogComponent: {screen: RNNativeBaseComponent.NBAlertDialogComponent,
            navigationOptions: ({ navigation }) => ({
                title: 'AlertDialog',
                headerStyle: {
                    backgroundColor: 'rgb(29,36,102)',                        
        ...
        NBMenuComponent: {screen: RNNativeBaseComponent.NBMenuComponent,
            navigationOptions: ({ navigation }) => ({
                title: 'Menu',
                headerStyle: {
                    backgroundColor: 'rgb(29,36,102)',                        
        ...
        NBModalComponent: {screen: RNNativeBaseComponent.NBModalComponent,
            navigationOptions: ({ navigation }) => ({
                title: 'Modal',
                headerStyle: {
                    backgroundColor: 'rgb(29,36,102)',                        
        ...
        NBAvatarComponent: {screen: RNNativeBaseComponent.NBAvatarComponent,
            navigationOptions: ({ navigation }) => ({
                title: 'Avatar',
                headerStyle: {
                    backgroundColor: 'rgb(29,36,102)',                        
        ...
        NBImageComponent: {screen: RNNativeBaseComponent.NBImageComponent,
            navigationOptions: ({ navigation }) => ({
                title: 'Image',
                headerStyle: {
                    backgroundColor: 'rgb(29,36,102)',                        
        ...
        NBFabComponent: {screen: RNNativeBaseComponent.NBFabComponent,
            navigationOptions: ({ navigation }) => ({
                title: 'Fab',
                headerStyle: {
                    backgroundColor: 'rgb(29,36,102)',                        
        ...
        PaperAppbarComponent: {screen: RNPaperComponent.AppbarComponent,
            navigationOptions: ({ navigation }) => ({
                title: 'Appbar',
                headerStyle: {
                    backgroundColor: 'rgb(98,0,238)',                        
        ...
        PaperAvatarComponent: {screen: RNPaperComponent.AvatarComponent,
            navigationOptions: ({ navigation }) => ({
                title: 'Avatar',
                headerStyle: {
                    backgroundColor: 'rgb(98,0,238)',                        
        ...
        PaperBannerComponent: {screen: RNPaperComponent.BannerComponent,
            navigationOptions: ({ navigation }) => ({
                title: 'Banner',
                headerStyle: {
                    backgroundColor: 'rgb(98,0,238)',                        
        ...
        PaperBottomNavigationComponent: {screen: RNPaperComponent.BottomNavigationComponent,
            navigationOptions: ({ navigation }) => ({
        ...
        PaperCardComponent: {screen: RNPaperComponent.CardComponent,
            navigationOptions: ({ navigation }) => ({
                title: 'Card',
                headerStyle: {
                    backgroundColor: 'rgb(98,0,238)',                        
        ...
        PaperChipComponent: {screen: RNPaperComponent.ChipComponent,
            navigationOptions: ({ navigation }) => ({
                title: 'Chip',
                headerStyle: {
                    backgroundColor: 'rgb(98,0,238)',                        
        ...
        PaperDialogComponent: {screen: RNPaperComponent.DialogComponent,
            navigationOptions: ({ navigation }) => ({
                title: 'Dialog',
                headerStyle: {
                    backgroundColor: 'rgb(98,0,238)',                        
        ...
        PaperDrawerComponent: {screen: RNPaperComponent.DrawerComponent,
            navigationOptions: ({ navigation }) => ({
                title: 'Drawer',
                headerStyle: {
                    backgroundColor: 'rgb(98,0,238)',                        
        ...
        PaperFABComponent: {screen: RNPaperComponent.FABComponent,
            navigationOptions: ({ navigation }) => ({
                title: 'FAB',
                headerStyle: {
                    backgroundColor: 'rgb(98,0,238)',                        
        ...
        PaperHelperTextComponent: {screen: RNPaperComponent.HelperTextComponent,
            navigationOptions: ({ navigation }) => ({
                title: 'HelperText',
                headerStyle: {
                    backgroundColor: 'rgb(98,0,238)',                        
        ...
        PaperIconButtonComponent: {screen: RNPaperComponent.IconButtonComponent,
            navigationOptions: ({ navigation }) => ({
                title: 'IconButton',
                headerStyle: {
                    backgroundColor: 'rgb(98,0,238)',                        
        ...
        PaperListComponent: {screen: RNPaperComponent.ListComponent,
            navigationOptions: ({ navigation }) => ({
                title: 'List',
                headerStyle: {
                    backgroundColor: 'rgb(98,0,238)',                        
        ...
        PaperMenuItemComponent: {screen: RNPaperComponent.MenuItemComponent,
            navigationOptions: ({ navigation }) => ({
                title: 'MenuItem',
                headerStyle: {
                    backgroundColor: 'rgb(98,0,238)',                        
        ...
        PaperModalComponent: {screen: RNPaperComponent.ModalComponent,
            navigationOptions: ({ navigation }) => ({
                title: 'Modal',
                headerStyle: {
                    backgroundColor: 'rgb(98,0,238)',                        
        ...
        PaperSearchbarComponent: {screen: RNPaperComponent.SearchbarComponent,
            navigationOptions: ({ navigation }) => ({
                title: 'Searchbar',
                headerStyle: {
                    backgroundColor: 'rgb(98,0,238)',                        
        ...
        PaperSnackbarComponent: {screen: RNPaperComponent.SnackbarComponent,
            navigationOptions: ({ navigation }) => ({
                title: 'Snackbar',
                headerStyle: {
                    backgroundColor: 'rgb(98,0,238)',                        
        ...
        PaperSurfaceComponent: {screen: RNPaperComponent.SurfaceComponent,
            navigationOptions: ({ navigation }) => ({
                title: 'Surface',
                headerStyle: {
                    backgroundColor: 'rgb(98,0,238)',                        
        ...
        PaperTextInputComponent: {screen: RNPaperComponent.TextInputComponent,
            navigationOptions: ({ navigation }) => ({
                title: 'TextInput',
                headerStyle: {
                    backgroundColor: 'rgb(98,0,238)',                        
        ...
        PaperToggleButtonComponent: {screen: RNPaperComponent.ToggleButtonComponent,
            navigationOptions: ({ navigation }) => ({
                title: 'ToggleButton',
                headerStyle: {
                    backgroundColor: 'rgb(98,0,238)',                        
